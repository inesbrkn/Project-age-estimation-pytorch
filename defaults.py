...
_C.MODEL.METHOD = "ordinal"  # "dex" "weightLoss" "balancedSoftmax" "laplace", "none" "gaussian" ou "residual" pour comparer les deux (même config recommandée)
